...
\title{\vspace{-4cm} \textbf{Informe Trabajo Final \\ \line(1,0){350}}\\
  \vspace{0.5cm}\centering{\includegraphics[scale=0.53]{img/logoUNC.png}}\\}
\author{\vspace{-0.25cm} Autores \vspace{0.25cm}\\ Gomez, Roberto Pablo - Lovaisa
Michelini Valeria \bigskip \bigskip \bigskip \\
  Tema \vspace{0.25cm} \\ \textbf{Sistema de Monitoreo y Registro de Datos Multiplataforma }\\ %\textbf{ Soft-Core y soporte Linux} \\ \textbf{}
  \bigskip \bigskip \bigskip \bigskip\\
 \begin{normalsize}Materia\end{normalsize} \\
  \begin{normalsize} Sistema De Computación \end{normalsize}\\ 
  \begin{normalsize}Docentes\end{normalsize}\\
  \begin{normalsize}Ing. Micolini, Orlando \end{normalsize} \\
  \begin{normalsize}Ing. Solinas, Miguel Angel \end{normalsize} \\
